...
from utils.network_structure import DuelingNetwork
...
if __name__ == "__main__":
    ...
    # for i in range(5):
    #     agent = DuelingDQNAgent(env, memory_size, batch_size, target_update, epsilon_decay)
    #     scores, losses, epsilons= agent.train(num_frames)
    #     with open("./save/dueling_dqn/scores_" + str(i) + ".txt", encoding="utf-8", mode="a") as f:
    #         f.writelines(str(scores))
    #     with open("./save/dueling_dqn/losses_" + str(i) + ".txt", encoding="utf-8", mode="a") as f:
    #         f.writelines(str(losses))
    #     with open("./save/dueling_dqn/epsilons_" + str(i) + ".txt", encoding="utf-8", mode="a") as f:
    #         f.writelines(str(epsilons))
    #     agent.save("./save/dueling_dqn/dueling_dqn_" + str(i) + ".pkl")
    agent = DuelingDQNAgent(env, memory_size, batch_size, target_update, epsilon_decay)
    agent.load("./save/dueling_dqn/dueling_dqn_4.pkl")
    # scores, losses, epsilons = agent.train(num_frames)
    video_folder = "videos/dueling_dqn"
