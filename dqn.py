...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        with open("./save/dqn/scores_" + str(i) + ".txt", encoding="utf-8", mode="a") as f:
            f.writelines(str(scores))
        with open("./save/dqn/losses_" + str(i) + ".txt", encoding="utf-8", mode="a") as f:
            f.writelines(str(losses))
        with open("./save/dqn/epsilons_" + str(i) + ".txt", encoding="utf-8", mode="a") as f:
            f.writelines(str(epsilons))
        agent.save("./save/dqn/dqn_" + str(i) + ".pkl")
    agent = DQNAgent(env, memory_size, batch_size, target_update, epsilon_decay)
    agent.load("./save/dqn/dqn_0.pkl")
